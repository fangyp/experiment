            ...
            <el-col :sm="24" :lg="24" :xl="24">
              ...
              >
                <el-form-item label="实验名称 :" prop="experiment_name">
                  <el-input
                    v-model="baseForm.experiment_name"
                    maxlength="20"
                ...
                <el-form-item label="温度℃ :" prop="temperature">
                  <el-input
                    v-model.number="baseForm.temperature"
                    type="number"
                    style="min-width:200px"
                  />
                </el-form-item>
                <el-form-item label="湿度RH% :" prop="humidity">
                  <el-input
                    v-model.number="baseForm.humidity"
                    type="number"
                    style="min-width:200px"
                  />
                </el-form-item>
                ...
                <tr>
                  ...
                  <td style="min-width:100px; width:15%">
                    <el-button
                      ...
                      icon="el-icon-plus"
                      style="color:#fff;"
                      @click="appendProcedure($event, index)"
                    >增加步骤</el-button>
                  </td>
                  <td />
                  ...
                  >
                    ...
                    <td :rowspan="procedure.experiment_parameters.length" class="seq-col">
                      <el-button
                        ...
                        icon="el-icon-minus"
                        circle
                        @click="removeProcedure($event, index)"
                      />
                    </td>
                    <!-- 步骤列 type="input"-->
                    <td :rowspan="procedure.experiment_parameters.length" class="first-col">
                      <el-form-item prop="procedure_title" style="vertical-align: middle;">
                        <el-input
                          type="textarea"
                          v-model="procedure.procedure_title"
                          maxlength="30"
                          :rows="2"
                          placeholder="步骤名称"
                        />
                    ...
                    >
                      <td>
                        <div>
                          <el-button
                            ...
                            icon="el-icon-plus"
                            circle
                            @click="appendParameter($event, 0, procedure)"
                          />
                        </div>
                      </td>
                      <td>
                        <el-form-item prop="reagent">
                          <el-input
                            v-model="procedure.experiment_parameters[0].reagent"
                            maxlength="50"
                          />
                        </el-form-item>
                      </td>
                      <td>
                        <el-form-item prop="theoretical_volum">
                          <el-input
                            v-model.number="procedure.experiment_parameters[0].theoretical_volum"
                            type="number"
                            maxlength="10"
                          />
                        </el-form-item>
                      ...
                      <td>
                        <el-form-item prop="actual_volum">
                          <el-input
                            v-model.number="procedure.experiment_parameters[0].actual_volum"
                            type="number"
                            maxlength="10"
                          />
                        </el-form-item>
                    ...
                    <td :rowspan="procedure.experiment_parameters.length" class="last-col">
                      <div>
                        <pre
                          v-show="procedure.has_record"
                          style="padding-left:10px;font-size:0.8em;text-align: left;"
                      ...
                      <div>
                        <el-button
                          ...
                          plain
                          circle
                          @click="appendRecordToProcedure($event, procedure, index)"
                        />
                      </div>
                    </td>
                  </tr>
                  ...
                  <template v-for="(parameters, index2) in procedure.experiment_parameters">
                    ...
                    >
                      <td>
                        ...
                        <div style="margin-bottom:5px;">
                          <el-button
                            ...
                            icon="el-icon-plus"
                            circle
                            @click="appendParameter($event, index2, procedure)"
                          />
                        </div>
                      </td>
                      <td>
                      ...
                      <td>
                        <el-form-item prop="theoretical_volum">
                          <el-input
                            v-model.number="parameters.theoretical_volum"
                            type="number"
                            maxlength="10"
                          />
                        </el-form-item>
      ...
      <el-tab-pane label="实验记录">
        ...
        >
          <el-alert
            ...
            class="small"
            style="margin-bottom: 10px;"
            title="温馨提示：你可以添加和实验步骤无关的实验记录内容"
          />
                ...
                >
                  ...
                  <td>
                    <el-button
                      ...
                      icon="el-icon-plus"
                      plain
                      @click="appendRecord($event, index)"
                    />
                    <el-button
                      type="danger"
                      size="mini"
                      icon="el-icon-delete"
                      plain
                      @click="removeRecord($event, index)"
                    />
                  </td>
                </tr>
              </tbody>
...
export default {
  ...
  methods: {
    ...
    removeParameter(event, index, procedure) {
      if (
        procedure.experiment_parameters &&
        procedure.experiment_parameters.length > 1
      ) {
        poppyjs.html.Dialog.showConfirm({
          msg: "确定移除本行实验步骤吗？",
          title: "移除实验步骤",
    ...
    // 提交保存的底层方法
    submitUpdate0(auto) {
      console.log("submitUpdate0000000");
      const self = this;
      ...
      experimentApi
        .updateExperiment(self.experimentId, params, auto)
        .then(function(resp) {});
    },
